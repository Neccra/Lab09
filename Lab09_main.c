...
void __ISR(_TIMER_2_VECTOR, IPL4AUTO) TimerInterrupt100Hz(void)
{
    ...
    if (buttonEvents & BUTTON_EVENT_4UP) {
        ...
        //generate a RESET_BUTTON event:
        battleboatEvent.type = BB_EVENT_RESET_BUTTON;
        return;
    }

    //every 10 cycles, attempt to run the transmission module.
    if (freerunning_timer % 10 == 0) {
